---
title: "dfr.dist: Hazard-First Survival Modeling"
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{dfr.dist: Hazard-First Survival Modeling}
...
`dfr.dist` takes a different approach: **you write the hazard function, and the
...
If you can express $h(t)$ as an R function of time and parameters, `dfr.dist`
...
curves, `dfr.dist` speaks your language. Define the hazard function that matches
...
and need more flexibility than Weibull or Cox regression, `dfr.dist` gives you
...
5. **`vignette("automatic_differentiation")`** — Analytical score and Hessian functions
