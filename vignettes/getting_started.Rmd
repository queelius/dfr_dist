---
title: "Getting Started with flexhaz"
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Getting Started with flexhaz}
...
The `flexhaz` package lets you work with survival distributions through their
