...
1. **`vignette("failure_rate")`** - Deep dive into hazard-based modeling
2. **`vignette("custom_distributions")`** - Create your own distributions
3. **`vignette("reliability_engineering")`** - Real-world applications
