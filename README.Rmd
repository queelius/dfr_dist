...
- [Dynamic Failure Rate Distributions](https://queelius.github.io/dfr_dist/articles/failure_rate.html) - Core concepts

**Creating Custom Distributions:**

- [Creating Custom Distributions](https://queelius.github.io/dfr_dist/articles/custom_distributions.html) - Build your own
- [Automatic Differentiation](https://queelius.github.io/dfr_dist/articles/automatic_differentiation.html) - Exact derivatives

**Applications:**

- [Reliability Engineering](https://queelius.github.io/dfr_dist/articles/reliability_engineering.html) - Real-world examples
...
- [`femtograd`](https://github.com/queelius/femtograd): Automatic differentiation via computational graphs
