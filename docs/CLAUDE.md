...
| [`score()`](https://queelius.github.io/likelihood.model/reference/score.html)             | Score function (gradient) | Numerical gradient of loglik           |
| [`hess_loglik()`](https://queelius.github.io/likelihood.model/reference/hess_loglik.html) | Hessian of log-likelihood | Numerical Hessian                      |
