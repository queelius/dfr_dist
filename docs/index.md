...
- **Flexible hazard specification**: Define any hazard function h(t,
  par, …)
- **Complete distribution interface**: Automatic computation of
  survival, CDF, PDF, quantiles
...
- **Integration with ecosystem**: Works with `algebraic.dist`,
...
Model complex failure patterns like bathtub curves (infant mortality +
...
|-------------------|-----------------------------|---------------------------------------------------------------------------|
| Cumulative hazard | $H(t) = \int_{0}^{t}h(u)du$ | [`cum_haz()`](https://queelius.github.io/dfr_dist/reference/cum_haz.md)   |
...
| PDF               | $f(t) = h(t) \cdot S(t)$    | [`pdf()`](https://queelius.github.io/algebraic.dist/reference/pdf.html)   |
